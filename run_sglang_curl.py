...
**分析目标代码：**
函数名称：FindBucketWhitelistCount
ORM代码：func (b *Bucket) FindBucketWhitelistCount(filterSource map[string]interface{}) (int, error) {
	var (
		nums    int64
		err     error
...
调用者：func (l *QueryBucketWhitelistLogic) QueryBucketWhitelist(req *types.QueryBucketWhitelistRequest, log *logger.IvcLog) (resp *types.QueryBucketWhitelistReponse, err error) {
	// 1. 参数校验
...
const IvcBucketWhitelistTable = "ivc_bucket_whitelist"
