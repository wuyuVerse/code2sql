    ...
    def format_code_metadata(self, code_meta_data: List[Dict]) -> str:
        ...
        for meta in code_meta_data:
            if not isinstance(meta, dict):
                continue
            code_key = meta.get('code_key') or meta.get('key') or meta.get('name', '')
            code_value = meta.get('code_value') or meta.get('value') or meta.get('content', '')
            code_file = meta.get('code_file') or meta.get('file') or meta.get('source', '')
